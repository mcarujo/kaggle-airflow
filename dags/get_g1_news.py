...
def download_g1_webpage():
    ...
    file = open(os.path.join(os.getenv('OUTPUTS'), "g1_sample.html"), "w")
...
# DAG
with DAG(
    "g1_example", schedule_interval="@daily", default_args=default_args, catchup=False
) as dag:
    ...
    downloading_g1_webpage = PythonOperator(
        task_id="downloading_g1_webpage", python_callable=download_g1_webpage
    )
